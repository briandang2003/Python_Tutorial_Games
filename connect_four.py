...
RED = (255,0,0)
YELLOW = (255,255,0)
# global varialbe and static variables
ROW_COUNT = 6
COLUMN_COUNT = 7
...
# initializing pygame 
pygame.init()
# suppose to show the thing but isn't 
...
# you can find these methods on the pygame website
draw_board(board)
pygame.display.update()
